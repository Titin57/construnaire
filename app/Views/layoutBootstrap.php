                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li<?php if ($currentPage == 'est'): ?> class="active"<?php endif; ?>>
                                    <a href="<?= $this->url('conference_est') ?>">Conférence Est</a>
                                </li>
                                <li<?php if ($currentPage == 'ouest'): ?> class="active"<?php endif; ?>>
                                    <a href="<?= $this->url('conference_ouest') ?>">Conférence Ouest</a>
                                </li>
